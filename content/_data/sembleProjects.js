...
export default async function() {
  try {
    const response = await fetch(
      'https://api.semble.so/xrpc/network.cosmik.collection.get?collectionId=9ad322f4-a838-475a-9efc-0e35c393ff28&page=1&limit=100&sortBy=createdAt&sortOrder=asc'
    );
